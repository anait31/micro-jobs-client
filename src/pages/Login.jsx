        ...
        <div className="w-1/4 mx-auto min-h-[calc(100vh-288px)] flex flex-col justify-center">
            ...
            <form className="space-y-3">
                <label className="input input-bordered flex items-center gap-2">
                    ...
                    <input type="text" name="username" className="grow focus:outline-none" placeholder="Username" />
                </label>
                <label className="input input-bordered flex items-center gap-2">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <label className="input input-bordered flex items-center gap-2">
                    ...
                    <input type="password" name="password" className="grow focus:outline-none" />
                </label>
